...
[Edutopia](https://www.edutopia.org) has reported extensively on schools where personalised learning has lifted attainment, particularly for students from disadvantaged backgrounds who previously fell through the cracks of a rigid curriculum.

And the research is broadly supportive. [The University of Edinburgh](https://www.ed.ac.uk) has found that well-designed personalised learning environments can improve engagement and outcomes — particularly when students feel a sense of ownership over their learning journey.
...
When students write by hand, they process information more deeply. [Research from the University of Edinburgh](https://www.ed.ac.uk) and others has consistently shown that handwriting engages cognitive pathways differently from typing — improving retention, comprehension, and creative thinking.
...
One challenge with this model is the divide between analogue in-class work and digital homework. Tools like the [Nuwa Pen](https://nuwapen.com) — an AI-powered smart pen that digitises handwritten notes from any paper surface — could bridge this gap beautifully.
