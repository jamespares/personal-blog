...
sqlite3 $DB "INSERT INTO products (name, slug, tagline, description, live_url, price, status, is_subproduct, published) VALUES ('Last Minute Lessons', 'last-minute-lessons', 'generate a bespoke podcast audio file, PPT, image and worksheet', 'Generate a bespoke podcast audio file, PPT, image and worksheet from a simple text prompt describing your lesson objective.', 'https://www.lastminutelessons.com', 'Subscription', 'active', 0, 1);"
...
sqlite3 $DB "INSERT INTO products (name, slug, tagline, description, live_url, price, status, is_subproduct, published) VALUES ('The DALF Dojo', 'the-dalf-dojo', 'AI-generated and marked past papers to pass the DALF C1 efficiently', 'Generate realistic DALF C1 past papers, complete them digitally, and receive instant marking against the official French Ministry of Education mark scheme. Practice with detailed feedback until you are exam-ready — the cheapest and most efficient way to pass.', 'https://thedalfdojo.com/', 'Free / Premium', 'active', 1, 1);"
