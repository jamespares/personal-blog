...
async function buildLang(lang) {
    ...
    await render('landing', `${prefix}index.html`, { ...langData, allProducts, recentPosts });
    ...
    await render('products', `${prefix}products/index.html`, { ...langData, activeProducts, comingSoonProducts });
    ...
    // Legal Pages
    await render('terms', `${prefix}terms/index.html`, { ...langData, pageTitle: dict.termsTitle, metaDescription: `${dict.termsTitle} for all EduConnect Asia Ltd products and services.` });
    await render('privacy', `${prefix}privacy/index.html`, { ...langData, pageTitle: dict.privacyTitle, metaDescription: `${dict.privacyTitle} for all EduConnect Asia Ltd products and services.` });
}
