        ...
        <footer class="site-footer">
          <div class="container">
            <div class="footer-social">
              <a href="https://www.linkedin.com/in/james-p-ba7653207/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><LinkedInIcon /></a>
              ...
              <a href={DISCORD_URL} target="_blank" rel="noopener noreferrer" aria-label="Discord" class="discord-link"><DiscordIcon /></a>
            </div>
            <p class="footer-copy">
