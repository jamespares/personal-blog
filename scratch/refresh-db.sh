...
sqlite3 $DB "INSERT INTO products (name, slug, tagline, description, live_url, price, status, is_subproduct, published) VALUES ('The DALF C1 Dojo', 'the-dalf-c1-dojo', 'Master the DALF C1', 'An AI powered DALF C1 past paper mastery system', 'https://thedalfdojo.com/', 'Free / Premium', 'active', 1, 1);"
